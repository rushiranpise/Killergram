...
public class MainHook implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(final LoadPackageParam lpparam) {
        ...
        XposedClass messageObject = new XposedClass("org.telegram.messenger.MessageObject", lpparam.classLoader);
        messageObject.hookAllMethods("canForwardMessage", XC_MethodReplacement.returnConstant(true));
        messageObject.hookAllMethods("isSecretMedia", XC_MethodReplacement.returnConstant(false));
